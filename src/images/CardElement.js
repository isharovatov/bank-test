...
export const CardElment = ({nameCard, dateCard, cardNumber, amount}) => {
    return (
<>
        ...
        <div className="front">
            ...
            <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg"
                ...
                <g id="Front">
                    ...
                    <text transform="matrix(1 0 0 1 60.106 295.0121)" id="svgnumber" className="st2 st3 st4">{cardNumber}</text>
                    <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" className="st2 st5 st6">{nameCard}</text>
                    <text transform="matrix(1 0 0 1 54.1074 389.8793)" className="st7 st5 st8">card name</text>
                    ...
                    <text transform="matrix(1 0 0 1 230 110)" className="st7 st5 st13">amount:</text>
                    <text transform="matrix(1 0 0 1 400 110)" className="st7 st5 st13">{amount}</text>
                    <g>
                        <text transform="matrix(1 0 0 1 574.4219 433.8095)" id="svgexpire" className="st2 st5 st9">{dateCard}</text>
